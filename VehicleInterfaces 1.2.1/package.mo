within ;
package VehicleInterfaces "VehicleInterfaces Library (Version 1.2.1) - Interface definitions and architectures for vehicle system modeling"
  ...
  annotation (
    ...
    revisionId="$Id:: package.mo 20128 2013-10-18 11:19:17Z#$",
