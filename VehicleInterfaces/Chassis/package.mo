...
<li><strong>steeringWheel</strong> - 1D rotational connection for the steering wheel connection to the driverEnvironment (optional)</li>
<li><strong>chassisMount</strong> - MultiBody connection providing a connection point to the vehicle body (optional)</li>
</ul>
