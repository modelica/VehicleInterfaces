...
<ul>
<li><strong>accessoryFlange</strong> - 1D rotational connection to the accessories subsystem (or other components driven by the engine)</li>
<li><strong>transmissionFlange</strong> - 1D rotational connection to the transmission subsystem</li>
...
<li><strong>engineMount</strong> - MultiBody connection to transmit the engine mount reactions (optional)</li>
</ul>
