...
<p><strong>Tutorial - Defining a new engine model</strong></p>
<p>The following process will demonstrate how to create a new engine model using this interface definition.</p>
<ol>
<li>Create a new model that extends <strong>VehicleInterfaces.Engines.Interfaces.Base</strong>, it should look like this:
...
<li>This dialog allows you to enable/disable the optional connections by setting <strong>includeAcceleratorPedal</strong> and <strong>includeMount</strong> as required for your new engine model.  The <strong>accessoriesFlange</strong> and <strong>transmissionFlange</strong> are of the type <a href=\"modelica://Modelica.Mechanics.MultiBody.Interfaces.FlangeWithBearing\">Modelica.Mechanics.MultiBody.Interfaces.FlangeWithBearing</a>, the parameters <strong>includeTransmissionBearing</strong> and <strong>includeAccessoriesBearing</strong> controls whether the bearing connectors within these connections are enabled or not.</li>
