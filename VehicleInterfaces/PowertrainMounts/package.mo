...
<ul>
<li><strong>chassisFrane</strong> - MultiBody connection to transmit the mounting system forces in to the vehicle body</li>
<li><strong>mount_n</strong> - MultiBody connection(s) to the powertrain subsystem reference frames</li>
</ul>
