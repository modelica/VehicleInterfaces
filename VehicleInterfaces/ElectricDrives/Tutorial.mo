...
<p><strong>Tutorial - Defining a new electric motor model</strong></p>
...
<ol>
<li>Create a new model that extends <strong>VehicleInterfaces.ElectricDrives.Interfaces.BaseDCMachine</strong>, it should look like this:
<br><br><img src=\"modelica://VehicleInterfaces/Resources/Images/ElectricDrives/buildNewElectricDrive1.png\"><br><br></li>
<li>In the component browser, right click on <strong>BaseDCMachine</strong> and select <strong>Parameters</strong> from the context menu to produce the following parameter dialog
<br><br><img src=\"modelica://VehicleInterfaces/Resources/Images/ElectricDrives/buildNewElectricDrive2.png\"><br><br></li>
<li>This dialog allows you to enable/disable the optional connections by setting <strong>includeBearing</strong> as required for your new motor model.  The shaft_b connector is of the type <a href=\"modelica://Modelica.Mechanics.MultiBody.Interfaces.FlangeWithBearing\">Modelica.Mechanics.MultiBody.Interfaces.FlangeWithBearing</a>, the parameter <strong>includeBearing</strong> controls whether the bearing connector within the shaft_b connector is enabled or not.</li>
