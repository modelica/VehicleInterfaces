...
<li><strong>chassisFrame</strong> &ndash; MultiBody connection providing a connection point to the vehicle body (optional)</li>
<li><strong>steeringWheel</strong> &ndash; steering wheel connection (optional)</li>
<li><strong>acceleratorPedal</strong> &ndash; 1D translational connection for the accelerator pedal connection to the driverEnvironment (optional)</li>
<li><strong>brakePedal</strong> &ndash; 1D translational connection for the brake pedal connection to the driverEnvironment (optional)</li>
<li><strong>clutchPedal</strong> &ndash; 1D translational connection for the clutch pedal connection to the driverEnvironment (optional, for manual gearboxes only)</li>
<li><strong>shiftConnector</strong> &ndash; shift connection to the driverEnvironment (optional, for manual gearboxes only)</li>
</ul>
