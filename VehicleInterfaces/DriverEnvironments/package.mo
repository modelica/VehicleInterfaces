...
<ul>
<li><strong>controlBus</strong> - control signal bus connection</li>
<li><strong>chassisFrame</strong> - MultiBody connection providing a connection point to the vehicle body (optional)</li>
<li><strong>steeringWheel</strong> - steering wheel connection (optional)</li>
<li><strong>acceleratorPedal</strong> - 1D translational connection for the accelerator pedal connection to the driverEnvironment (optional)</li>
<li><strong>brakePedal</strong> - 1D translational connection for the brake pedal connection to the driverEnvironment (optional)</li>
<li><strong>clutchPedal</strong> - 1D translational connection for the clutch pedal connection to the driverEnvironment (optional, for manual gearboxes only)</li>
<li><strong>shiftConnector</strong> - shift connection to the driverEnvironment (optional, for manual gearboxes only)</li>
</ul>
