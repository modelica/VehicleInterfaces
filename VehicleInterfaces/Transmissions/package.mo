...
<ul>
<li><strong>engineFlange</strong> &ndash; 1D rotational connection to the engine subsystem (or other systems connected to the transmission input)</li>
<li><strong>drivelineFlange</strong> &ndash; 1D rotational connection to the driveline subsystem (or other systems connected to the transmission output)</li>
...
<li><strong>transmissionMount</strong> &ndash; MultiBody connection to transmit the transmission mount reactions (optional)</li>
</ul>
